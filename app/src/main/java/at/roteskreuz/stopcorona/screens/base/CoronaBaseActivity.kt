...
import at.roteskreuz.stopcorona.screens.debug.exposure_notification_infection_messages.startDebugExposureNotificationsTracingKeysFragment
...
open class CoronaBaseActivity(@LayoutRes layout: Int = R.layout.framelayout) : BaseActivity(layout) {
    ...
    override fun onOptionsItemSelected(item: MenuItem?): Boolean {
        return when (item?.itemId) {
            ...
            R.id.debugExposureNotificationsTrackingKeys -> {
                startDebugExposureNotificationsTracingKeysFragment()
                true
            }
